...
import { Eye, EyeOff, Users, BarChart3 } from "lucide-react";
        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              Streamline your visitor management with our comprehensive
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-gray-600">
                Manage users and permissions across multiple branches
              </p>
            </div>
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-gray-600">
                Comprehensive reporting and visitor insights
              </p>
            </div>
          </div>
        </div>
